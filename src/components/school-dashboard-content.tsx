...
import { GraduationCap, Users, Clock, Calendar, Search, BarChart, Package, Check, AlertCircle, Plus, Minus, Save, X, Pencil, Trash2, Loader2 } from 'lucide-react';
                ...
                <div className="p-6 bg-white border-b border-slate-100 shadow-sm relative overflow-hidden shrink-0">
                    ...
                    <div className="relative z-10 text-left">
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            <div>
                                <h1 className="text-2xl font-bold flex items-center gap-2 text-slate-800 break-words leading-tight">
                                ...
                                <div className="flex flex-col gap-3 md:gap-4">
                                    <Card className="bg-white border-0 shadow-sm rounded-xl flex-1">
                                        ...
                                        <CardContent className="p-2 md:p-3 space-y-1.5">
                                            ...
                                            <div className="flex items-center gap-3">
                                                <div className="w-8 h-8 rounded-full bg-green-50 flex items-center justify-center shrink-0 text-green-600">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" /></svg>
                                                </div>
                                                <div className="flex-1 min-w-0">
                                                    {isEditing ? (
